...
public class ProductRepositoryTests {
	...
	public void testCreateProduct2() {
		...
		product.setShortDescription("A good Pc from Dell");
		product.setFullDescription("This is a very good Computer full description");
	...
	public void testCreateProduct3() {
		...
		product.setShortDescription("A good Desktop from Dell");
	...
	public void testListAllProducts() {
		Iterable<Product> listAllProducts = repo.findAll();
	...
	public void testUpdateProduct() {
		...
		product.setPrice(498);
		
		repo.save(product);
		
		Product updatedProduct = entityManager.find(Product.class, id);
		 
		assertThat(updatedProduct.getPrice()).isEqualTo(498);
	}
